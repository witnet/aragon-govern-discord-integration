...
export function createDataRequest (channelId: string, messageId: string) {
  ...
  const requestJson = `{"jsonrpc":"2.0","method":"sendRequest","id":"1","params":{"dro":{"data_request":{"time_lock":0,"retrieve":[{"kind":"HTTP-GET","url":"PLACEHOLDER_URL_1","script":[130, 24, 119, 130, 24, 101, 104, 112, 111, 115, 105, 116, 105, 118, 101]},{"kind":"HTTP-GET","url":"PLACEHOLDER_URL_2","script":[130, 24, 119, 130, 24, 101, 104, 112, 111, 115, 105, 116, 105, 118, 101]},{"kind":"HTTP-GET","url":"PLACEHOLDER_URL_3","script":[130, 24, 119, 130, 24, 101, 104, 112, 111, 115, 105, 116, 105, 118, 101]}],"aggregate":{"filters":[],"reducer":2},"tally":{"filters":[{"op":8,"args":[]}],"reducer":2}},"witness_reward":1000,"witnesses":3,"commit_and_reveal_fee":10,"min_consensus_percentage":51,"collateral":1000000000},"fee":0}}`
